...
of Alpine Linux with KDE Plasma desktop.
...
Alpine Linux features:
  ...
  * OpenRC init system
  * apk package manager
  * Minimal footprint, ideal for desktops and servers
  * Security-oriented with hardened kernel options
...
supported: the Alpine minirootfs, apk packages, GRUB target and bundled
